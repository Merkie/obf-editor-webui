import { createSignal, onMount, For, Show, createEffect, JSX } from "solid-js";
    ...
    >
      ...
      >
        ...
        <UIPanel moveable={true} label="Explorer">
          <div class="border-y border-neutral-900">
          ...
          <div class="flex-1 relative mt-1">
            <div class="flex flex-col absolute top-0 left-0 w-full h-full overflow-y-auto custom-scrollbar">
              <For each={boardNames()}>
                {({ name, id }) => (
                  <button
                    onClick={async () => {
                      ...
                      if (board) {
                        const parsedBoard = JSON.parse(board.data);
